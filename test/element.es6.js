...
smoke.defTest({
	...
	tests: [
		["constructor", function(){
			...
			let e = new Element("div", {className: "status", tabIndex: -1, bdReflectClass: "label"}, "status:");
			assert(e.type === "div");
		...
		["children", function(){
			...
			let greeting = new Element("div", "hello, ");
			...
			let child1 = new Element("div", "Larry");
			let child2 = "Curly";
			let child3 = {
				toString(){
					return "Moe";
			...
			let illegalChild = Symbol("illegalChild");
...
// just a repeat of the test above, but using "e" rather than "new Element"; yet another example of why we need lisp macros
...
smoke.defTest({
	...
	tests: [
		["constructor", function(){
			// here's a typical Element with all constructor arguments utilized
			// (imagine a div that has CSS that changes its :after content and color based on it's class)
			let result = e("div", {className: "status", tabIndex: -1, bdReflectClass: "label"}, "status:");
