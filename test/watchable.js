...
const test2 = ['data[0] = {label: "g", value: 6}', {
    '(data, 0)': {
...
const test4 = ['data.push({label: "g", value: 6})', {
    '(data)': {
        newValue: [{label: 'A', value: 0}, {
            label: 'B',
            value: 1
...
const test6 = ['data.unshift({label: "g", value: 6}, {label: "h", value: 7})', {
    '(data, 0)': {
        newValue: {
            label: 'g',
            value: 6
...
const test8 = ['data.splice(0, 0, {label:"AA", value:10})', {
    '(data, 0)': {
