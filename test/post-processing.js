...
smoke.defBrowserTest({
    ...
    tests: [
        ['advise', function () {
            ...
            const c = new Component2();
            c.render();

            const event1 = {type: 'event1'};
            const event2 = {type: 'event2'};
            const event3 = {type: 'event3'};
            const event4 = {type: 'event4'};
            const event5 = {type: 'event5'};
            const event6 = {type: 'event6'};
            const event7 = {type: 'event7'};
            const event8 = {type: 'event8'};
        ...
        ['parent attach point', function () {
            ...
            const c = new Component6({});
            c.render();

            const child1 = c.insChild(e(Component, {}));
            const child2 = c.insChild(e(Component, {bdParentAttachPoint: 'node1'}));
            const child3 = c.insChild(e(Component, {bdParentAttachPoint: 'node2'}));
        ...
        ['children attach point', function () {
            ...
            const c = new Component7({});
            c.render();

            const child = c.insChild(e(Component, {}));
        ...
        ['reflect', function () {
            ...
            const c = new TestReflect({value: 2});
            assert(c.value === 2);
        ...
        ['reflect-class-part', function () {
            ...
            const instanceOfSomeClass = new SomeClass({value: 'test1'});
